...
2. <p>Enter NeSI username (all lower case letters), HPC password and 6 digit second factor token<br><p align="center"><img src="/img/jupyter_login_labels_updated.png" alt="drawing" width="700"/></p></p>
